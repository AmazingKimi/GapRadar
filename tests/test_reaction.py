...
from gapradar.reaction import ReactionCandidate, canonical_url, dedupe_candidates, is_migration_pain, score_migration_pain
...
def test_verify_sets_demand_status_after_validation():
    event = _event()

...
<body><main>
<div class="eyebrow">Market Change Intelligence · v0.2</div>
<h1>GapRadar</h1>
<p class="lede">Verified shutdowns, pricing shocks and API or policy changes. V0.2 is deliberately precision-first: explicit first-party change notices enter the radar; incidental deprecation mentions do not.</p>
...
<footer>Generated by GapRadar v0.2 · No official first-party source, no verified event · Precision before coverage.</footer>
</main></body></html>"""
